          ...
          >
            ...
            >
              ...
              >
                ...
                <div
                  className={`flex flex-col gap-1 absolute h-[60%] overflow-auto bg-background z-50 top-1/2 -translate-y-1/2 p-1 rounded border border-accent transition-all pointer-events-auto left-1 ${
                    playlist ? "" : "hide-a"
                  }`}
                >
